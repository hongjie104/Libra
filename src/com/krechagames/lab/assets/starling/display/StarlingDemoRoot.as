 ...
 * Time: 17:49
 */
package com.krechagames.lab.assets.starling.display {
	...
	public class StarlingDemoRoot extends Sprite {
		...
		public function StarlingDemoRoot() {
		...
		private function init(e:starling.events.Event):void {
			...
			//option #2: manually load, without config
			/*
			loader.load(Vector.<IAsset>([
				new TextAsset("db", "assets/data/db.csv", "common"),
				new TextAsset("lang", "assets/data/lang.xml", "common"),
				new SoundAsset("music", "assets/sounds/music.mp3", "common"),
				new ImageAsset("bg", "assets/textures/bg@x1.jpg", "x1"),
				new ImageAsset("logotype", "assets/textures/logotype@x1.jpg", "x1"),
				new ImageAsset("atlas", "assets/textures/atlas@x1.png", "x1"),
				new TextAsset("atlas_xml", "assets/textures/atlas@x1.xml", "x1"),
				new RawDataAsset("compressed_texture", "assets/textures/compressed_texture@x1.atf", "x1")
