package org.libra.utils.encrypt {
	...
	public final class AES {
		...
		private static const BIT_KEY_128:int = 128;
		
		private static const BIT_KEY_192:int = 192;
		
		private static const BIT_KEY_256:int = 256;
		...
		public static function encrypt(plaintext:String, password:String, nBits:int):String {
			...
			var nBytes:int = nBits >> 3;  // no bytes in key
